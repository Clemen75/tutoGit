...
//Première méthode - 1
 var tabObject = .... ; //faire le tableau javascript des questions 
...
//window.onload=alert(myObject[1].choix[myObject[1].reponse]);
...
function htmlQuestion(numQ) {
	...
	// 	   Afficher par une boucle indicée, les différents choix possibles sous forme d'un liste à puces <ul>.
	//		l'indice de boucle servant à repérer ce choix.
	// 	   Optionnellement, s'aider de la fonction htmlLiInput() - à écrire -, servant à l'affichage d'un des éléments de liste.
	// 		  suivant 3 paramètres  : 
	//		  l'indice de la question (numQ), l'indice d'une des réponses à la question (iChoix) et le texte de cette réponse (Choix).
	return quest;
}
