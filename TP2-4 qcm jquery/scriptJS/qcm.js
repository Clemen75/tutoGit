...
//3 fonctions supplÃ©mentaires
function htmlDivDraggable(iChoix,text){
//construction d'un div prÃ©sentant un choix
...
function htmlQuestion(){
	...
	//prÃ©sentation de l'Ã©noncÃ© avec ses choix, sous forme de div dites draggable
	...
	//crÃ©ation de la div devant recevoir la rÃ©ponse, dites droppable
...
//rep objet $ reprÃ©sentant le paragraphe de la div panier
	clearTimeout(timer); 	//stoppe le timer
	
	//analyse de la rÃ©ponse cliquÃ©e et suivant le cas
	// A FAIRE
}

function prepare_div_event() { //fonction lancÃ©e aprÃ¨s le chargt des objets-balises en mémoire
	// A FAIRE
};
